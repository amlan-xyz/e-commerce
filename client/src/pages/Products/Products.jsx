    ...
    return(
        <section className="products__section">
            <h1>Products page</h1>
                ...
                <input id="search" value={state.searchQuery} type="text" onChange={(e)=>dispatch({type:"SEARCH",payload:e.target.value})} />        

                
               
                <label htmlFor="">Sort Price High To low</label>
                <input type="radio" checked={state.sortHighToLow===true} onChange={(e)=>dispatch({type:"SORT_BY_PRICE",payload:true})} />
                <label htmlFor="">Sort Price Low to High</label>
                <input checked={state.sortHighToLow===false} type="radio" name="sortPrice"  onChange={(e)=>dispatch({type:"SORT_BY_PRICE",payload:false})}  />
